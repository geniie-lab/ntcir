# Welcome to NTCIR AgenticInstruction Task
...
!!! warning "Notable changes from the kick-off event"
    ...
    - Only BM25 and Sparse Encoder will be used as official IR models in NTCIR-19.
        - Participants are welcome to index the dataset with other IR models in your additional analyses and report findings in the participant paper.
