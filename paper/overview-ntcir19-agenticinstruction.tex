...
\url{https://github.com/geniie-lab/geniie-lab}}, an open-source controlled
experimentation testbed for model search behaviour, which extends the
experimental framework of Joho and Jose~\cite{joho2025sigir}. The testbed
...
\begin{itemize}
  ...
  mixture-of-experts model) accessed via Amazon Bedrock, with
  \texttt{temperature}~$= 0.0$ and \texttt{top\_p}~$= 1.0$;
  ...
  multilingual learned sparse encoder
  (\texttt{opensearch-neural-sparse-encoding-multilingual-v1}) over
